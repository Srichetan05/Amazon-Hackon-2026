...
export function routeProduct({ userLat, userLng, userLabel, grade, damageLevel, product, warehouses, deliveryPoints, config }) {
  ...
  if (effectiveDamageLevel === DAMAGE_LEVELS.IRREPAIRABLE) {
    return {
      ...
      justification: `This product has irrepairable damage and cannot be refurbished or resold. It will be evaluated for donation or sent to a certified recycling facility — no warehouse return needed.`,
